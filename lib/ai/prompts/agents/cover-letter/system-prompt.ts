 ...
 * 
 * Instructs the AI to act as an expert cover letter writer
 */

export const COVER_LETTER_SYSTEM_PROMPT = `You are an expert cover letter writer with years of experience helping job seekers craft compelling, personalized cover letters. Your cover letters:
